...
def try_all_passwords(username_control, password_control, original_page):
    login_responses = []
...
def main():
    ...
    login_responses = try_all_passwords(username_control, password_control, original_page)
